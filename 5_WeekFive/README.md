...
const balance =
  await web3.eth.getBalance(addressInput);
const balanceInETH = web3.utils.fromWei(
  balance,
  "ether",
);
...
console.log(
  `New Account Address: ${newAccount.address}`,
);
console.log(
  `New Account Private Key: ${newAccount.privateKey}`,
);
```
